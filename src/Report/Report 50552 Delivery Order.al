        ...
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            dataitem("Sales Shipment Line"; "Sales Shipment Line")
            {
                ...
                var
                    ...
                    // PackagingLines_lRec: Record "Packaging detail Line"; //Enable with Packaging extension.T13980
                ...
                begin
                    ...
                    // if "Sales Shipment Line"."Packaging Code" = '' then begin //Enable with Packaging extension.T13980
                    ILE_lRec.Reset();
                    ILE_lRec.SetRange("Document No.", "Sales Shipment Header"."No.");
                    ILE_lRec.SetRange("Document Line No.", "Sales Shipment Line"."Line No.");
                    ILE_lRec.SetRange("Item No.", "Sales Shipment Line"."No.");
                    ...
                    If ILE_lRec.FindSet() then
                        ...
                        until ILE_lRec.Next() = 0;
                    // end else begin //Enable with Packaging extension.T13980
                    //Write code for getting the Primary packing quantity and text with Packaging code functionality.
                    //Enable with Packaging extension.T13980 - NS
                    ...
                    //     until ILE_lRec.Next() = 0;
                    // end;
                    //Enable with Packaging extension.T13980 - NE
